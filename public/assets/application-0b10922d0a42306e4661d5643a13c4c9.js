    ...
    Tour = (function() {
      function Tour(options) {
        this._options = $.extend({
          ...
          duration: false,
          basePath: "",
          template: "<div class='popover tour'>          <div class='arrow'></div>          <h3 class='popover-title'></h3>          <h3 class='popover-content'></h3>          <div class='popover-navigation'>            <a class='btn btn-mini btn-inverse' data-role='prev'>Prev</a>            <a class='btn btn-mini btn-inverse' data-role='next'>Next</a>          </div>          </nav>        </div>",
...
(function() {
  $(function() {
    var intro1, intro10, intro2, intro3, intro4, intro45, intro5, intro6, intro7, intro8, intro9, options, tour;
    options = {
      name: "tour",
      container: "body",
      keyboard: true,
    ...
    intro1 = {
      ...
      animation: true,
      backdrop: false,
      template: "<div class='popover tour'>    <div class='arrow'></div>    <h3 class='popover-content'></h3>    <div class='popover-navigation'>        <a data-role='next'>Next</a>    </div>    </nav>  </div>"
    };
    intro2 = {
      element: "ul.create",
    ...
    intro10 = {
      ...
      animation: false,
      backdrop: false,
      template: "<div class='popover tour'>    <div class='arrow'></div>      <a  class='btn btn-block btn-inverse' data-role='end'>        <h3 class='popover-content'></h3>      </a>    </nav>  </div>"
    };
...
(function() {
  $(document).on("ajax:success", "a.upvote", function(e, data, status, xhr) {
    var $item, score;
    score = data.cached_votes_score;
    $(this).parent().find('a.score').text(score);
    return $item = $(this).parents('.list-group-item');
  });

  $(document).on("ajax:success", "a.downvote", function(e, data, status, xhr) {
    var $item, score;
    score = data.cached_votes_score;
    $(this).parent().find('a.score').text(score);
    return $item = $(this).parents('.list-group-item');
...
(function() {
  $(function() {
    return filepicker.setKey('AoaxmLrr2Tj2EbZv0JS0Mz');
  });
